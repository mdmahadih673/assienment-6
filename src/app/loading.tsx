                ...
                <div className="rounded-2xl bg-neutral-900 px-8 py-16 sm:px-12 lg:px-16">
                    <div className="flex flex-col items-center gap-10 lg:flex-row lg:justify-between">
                        <div className="w-full max-w-xl">
                            ...
                            <div className="mt-3 h-9 w-full max-w-md animate-pulse rounded bg-neutral-800" />
                            <div className="mt-2 h-9 w-2/3 animate-pulse rounded bg-neutral-800" />
                            <div className="mt-5 h-3 w-full animate-pulse rounded bg-neutral-800" />
                            <div className="mt-2 h-3 w-3/4 animate-pulse rounded bg-neutral-800" />
                            <div className="mt-7 h-10 w-40 animate-pulse rounded-md bg-neutral-800" />
                        </div>
                        <div className="h-64 w-64 shrink-0 animate-pulse rounded-xl bg-neutral-800" />
                    </div>
                </div>
            </div>
